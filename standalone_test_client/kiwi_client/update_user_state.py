...
async def main():
    ...
    DOCNAME_TO_DELETE = "user_state_example-user-4"  # Update this with your actual docname
    
    # LinkedIn URL for initialization
    LINKEDIN_PROFILE_URL = "https://www.linkedin.com/in/example-user-4/"  # Update this with actual LinkedIn URL
    
    # Organization UUID (for on_behalf_of_user_id parameter)
    ORGANIZATION_UUID = "856621b5-2866-420f-9984-8b4726b206b1"  # Update this with actual org UUID
    
    # Convert string UUID to uuid.UUID object if provided
    on_behalf_of_user_id = uuid.UUID(ORGANIZATION_UUID) if ORGANIZATION_UUID else None
