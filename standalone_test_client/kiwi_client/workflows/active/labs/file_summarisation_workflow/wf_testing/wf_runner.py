...
from kiwi_client.workflows.active.labs.file_summarisation_workflow.wf_testing.wf_inputs import (
    test_name,
    test_scenario,
    predefined_hitl_inputs,
)

from kiwi_client.workflows.active.labs.file_summarisation_workflow.wf_testing.sandbox_setup_docs import (
    setup_docs,
    cleanup_docs,
)

from kiwi_client.workflows.active.labs.file_summarisation_workflow.wf_testing.wf_validation import (
    validate_file_summarisation_output,
    display_summarisation_results,
)


WORKFLOW_NAME_TO_INGEST_AS_FOR_TESTING = "test_file_summarisation_workflow"
...
async def main_test_file_summarization():
    """
    Test the File Summarisation Workflow with enhanced functionality.
    """
    ...
    try:
        final_status, final_outputs = await run_workflow_test(
            ...
            validate_output_func=validate_file_summarisation_output,
        ...
        # Display results
        if final_outputs:
            display_summarisation_results(final_outputs)
...
if __name__ == "__main__":
    ...
    print("Run from project root: PYTHONPATH=$(pwd):$(pwd)/services poetry run python standalone_test_client/kiwi_client/workflows/active/labs/file_summarisation_workflow/wf_testing/wf_runner.py")
