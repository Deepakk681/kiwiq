...
from kiwi_client.workflows.active.content_diagnostics.linkedin_scraping_sandbox.wf_linkedin_scraping_json import (
    workflow_graph_schema,
)

from kiwi_client.workflows.active.content_diagnostics.linkedin_scraping_sandbox.wf_testing.wf_inputs import (
    test_name,
    test_scenario,
)

from kiwi_client.workflows.active.content_diagnostics.linkedin_scraping_sandbox.wf_testing.sandbox_setup_docs import (
    setup_docs,
    cleanup_docs,
)

WORKFLOW_NAME_TO_INGEST_AS_FOR_TESTING = "test_linkedin_scraping_sandbox_workflow"
...
def get_workflow_paths():
    ...
    workflow_folder = current_file_dir.parent  # workflow main folder (linkedin_scraping_sandbox)
