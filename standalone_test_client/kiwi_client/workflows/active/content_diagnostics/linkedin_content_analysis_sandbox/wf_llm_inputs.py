...
# Max Tokens by Step
LLM_MAX_TOKENS_THEMES = 10000  # Step 1: Theme Extraction
LLM_MAX_TOKENS_CLASSIFY = 10000  # Step 2: Post Classification
LLM_MAX_TOKENS_ANALYSIS = 10000  # Step 3: Theme Analysis

# Model Names by Step
EXTRACTION_MODEL = "gpt-5"  # Step 1: Theme Extraction
EXTRACTION_MODEL_FOR_CLASSIFY = "gpt-5-mini"  # Step 2: Post Classification (uses mini for efficiency)

# =============================================================================
# LLM Inputs for LinkedIn Content Analysis Workflow
# =============================================================================
# This file contains prompts, schemas, and configurations organized by workflow steps:
# 1. Theme Extraction - Identify 5 key content themes from all LinkedIn posts
# 2. Post Classification - Assign each post to the most relevant theme
# 3. Theme Analysis - Comprehensive analysis of posts within each theme group
...
# =============================================================================
# First step that analyzes all LinkedIn posts to identify exactly 5 distinct
# content themes that represent the author's recurring focus areas.

# Theme Extraction System Prompt
...
# Theme Extraction User Prompt Template
...
# Variables Used in Theme Extraction Prompts:
"""
Variables that go into the Theme Extraction prompts:
- posts_json: JSON representation of all LinkedIn posts for the entity (includes post content, metadata, engagement metrics)
"""

# Theme Extraction Output Schema
...
# =============================================================================
# Second step that classifies posts in batches, assigning each post to the most
# relevant theme identified in Step 1.
...
- themes_json: JSON of the 5 extracted themes from Step 1 (includes theme_id, theme_name, theme_description)
- posts_batch_json: JSON of current batch of posts to classify (includes post URN, content, metadata)
"""
...
# =============================================================================
# Third step that performs comprehensive analysis on posts grouped by theme,
# generating detailed performance metrics and actionable recommendations.

# Theme Analysis System Prompt
...
# Theme Analysis User Prompt Template
...
# Variables Used in Theme Analysis Prompts:
"""
Variables that go into the Theme Analysis prompts:
- theme_name: Name of the theme being analyzed
- theme_id: Unique identifier of the theme
- theme_description: Detailed description of the theme
- theme_group_json: JSON of posts in this theme (includes all post data, engagement metrics, classifications)
"""

# Theme Analysis Output Schema
# Sub-schemas
