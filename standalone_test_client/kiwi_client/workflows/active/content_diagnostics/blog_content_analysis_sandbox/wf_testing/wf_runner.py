...
from kiwi_client.workflows.active.content_diagnostics.blog_content_analysis_sandbox.wf_blog_content_analysis_json import (
    workflow_graph_schema,
)

from kiwi_client.workflows.active.content_diagnostics.blog_content_analysis_sandbox.wf_testing.wf_inputs import (
    test_name,
    test_scenario,
)

from kiwi_client.workflows.active.content_diagnostics.blog_content_analysis_sandbox.wf_testing.sandbox_setup_docs import (
    setup_docs,
    cleanup_docs,
)

WORKFLOW_NAME_TO_INGEST_AS_FOR_TESTING = "test_blog_content_analysis_sandbox_workflow"
...
def get_workflow_paths():
    ...
    workflow_folder = current_file_dir.parent  # workflow main folder (blog_content_analysis_sandbox)
...
async def validate_blog_content_analysis_output(outputs: Optional[Dict[str, Any]]) -> bool:
    """
...
async def main_test_brief_to_blog():
    ...
    try:
        final_status, final_outputs = await run_workflow_test(
            ...
            validate_output_func=validate_blog_content_analysis_output,
