...
# =============================================================================
# LLM Inputs for Company Analysis Workflow
# =============================================================================
# STEP 1: Perplexity Company Research (for insufficient content path)
# STEP 2: Document Analysis - Extract company intelligence from internal documents
# STEP 3: Unique Report Generation - Synthesize all analyses into comprehensive report
# STEP 4: Reddit Query Generation - Generate targeted Reddit search queries
# STEP 5: Reddit Research - Analyze Reddit discussions for market insights
# STEP 6: Final Insights & Content Pillars - Strategic content pillars aligned with market

# =============================================================================
# STEP 1: PERPLEXITY COMPANY RESEARCH
# =============================================================================
# Conducts foundational company research when insufficient content exists, gathering
# public information about the company to create foundational understanding
...
# Variables Used:
# - {company_context}: Context information about the company including name and any available details

# Output Schema (defined at end of file): PERPLEXITY_COMPANY_RESEARCH_OUTPUT_SCHEMA

# =============================================================================
# STEP 2: DOCUMENT ANALYSIS
# =============================================================================
# Analyzes batched internal documents to extract key business information, identifies
# products, services, capabilities, and target audience insights
...
# Variables Used:
# - {company_goals}: Company's stated goals and objectives
# - {documents_batch}: Batch of internal company documents to analyze

# Output Schema (defined at end of file): DOCUMENT_ANALYSIS_OUTPUT_SCHEMA

# =============================================================================
# STEP 3: UNIQUE REPORT GENERATION
# =============================================================================
# Synthesizes multiple analysis reports into a single, comprehensive report with
# only unique information, eliminating duplicates and consolidating similar insights
...
# Variables Used:
# - {collected_analyses}: Collection of analysis reports from document batches
# - {perplexity_research_section}: Optional Perplexity research results (if available)

# Output Schema (defined at end of file): UNIQUE_REPORT_OUTPUT_SCHEMA

# =============================================================================
# STEP 4: REDDIT QUERY GENERATION
# =============================================================================
# Generates strategic Reddit search queries to uncover real user discussions, pain
# points, and needs in the company's industry
...
# Variables Used:
# - {company_report}: Comprehensive company analysis report from previous step

# Output Schema (defined at end of file): REDDIT_QUERY_OUTPUT_SCHEMA

# =============================================================================
# STEP 5: REDDIT RESEARCH
# =============================================================================
# Analyzes Reddit discussions to extract insights about user pain points, feature
# requests, current solutions, decision criteria, and market trends
...
# Variables Used:
# - {search_query}: The Reddit search query to execute
# - {query_intent}: What insights this query aims to uncover

# Output Schema (defined at end of file): REDDIT_RESEARCH_OUTPUT_SCHEMA

# =============================================================================
# STEP 6: FINAL INSIGHTS & CONTENT PILLARS
# =============================================================================
# Synthesizes Reddit research with company analysis to create data-driven content
# pillars that align business goals with verified market needs
...
# Variables Used:
# - {reddit_research_results}: Collection of Reddit research insights from previous step
# - {company_analysis}: Comprehensive company analysis report
# - {company_goals}: Company's business goals and objectives

# Output Schema (defined at end of file): FINAL_INSIGHTS_OUTPUT_SCHEMA

# =============================================================================
# PYDANTIC SCHEMAS
# =============================================================================
# All output schemas for the workflow steps defined below
