...
from kiwi_client.workflows.active.content_diagnostics.company_ai_visibility_workflow_sandbox.wf_company_ai_visibility_workflow_json import (
    workflow_graph_schema,
)

from kiwi_client.workflows.active.content_diagnostics.company_ai_visibility_workflow_sandbox.wf_testing.wf_inputs import (
    test_name,
    test_scenario,
)

from kiwi_client.workflows.active.content_diagnostics.company_ai_visibility_workflow_sandbox.wf_testing.sandbox_setup_docs import (
    setup_docs,
    cleanup_docs,
)

WORKFLOW_NAME_TO_INGEST_AS_FOR_TESTING = "test_company_ai_visibility_workflow_sandbox_workflow"
...
def get_workflow_paths():
    ...
    workflow_folder = current_file_dir.parent  # workflow main folder (company_ai_visibility_workflow_sandbox)
...
async def validate_company_ai_visibility_workflow_output(outputs: Optional[Dict[str, Any]]) -> bool:
    """
    ...
    logger.info("Validating company ai visibility workflow outputs...")
...
async def main_test_company_ai_visibility_workflow():
    ...
    try:
        final_status, final_outputs = await run_workflow_test(
            ...
            validate_output_func=validate_company_ai_visibility_workflow_output,
...
if __name__ == "__main__":
    ...
    print("Run from project root: PYTHONPATH=. python kiwi_client/workflows_for_blog_teammate/wf_company_ai_visibility_workflow.py")
