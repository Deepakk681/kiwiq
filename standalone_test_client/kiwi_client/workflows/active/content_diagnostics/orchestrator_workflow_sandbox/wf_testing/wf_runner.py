...
from kiwi_client.workflows.active.content_diagnostics.orchestrator_workflow_sandbox.wf_orchestrator_workflow_json import (
    workflow_graph_schema,
)

from kiwi_client.workflows.active.content_diagnostics.orchestrator_workflow_sandbox.wf_testing.wf_inputs import (
    test_name,
    test_scenario,
)

from kiwi_client.workflows.active.content_diagnostics.orchestrator_workflow_sandbox.wf_testing.sandbox_setup_docs import (
    setup_docs,
    cleanup_docs,
)

WORKFLOW_NAME_TO_INGEST_AS_FOR_TESTING = "test_orchestrator_workflow"
...
def get_workflow_paths():
    ...
    workflow_folder = current_file_dir.parent  # workflow main folder (orchestrator_workflow_sandbox)
...
async def validate_orchestrator_workflow_output(outputs: Optional[Dict[str, Any]]) -> bool:
    """
    ...
    logger.info("Validating orchestrator workflow outputs...")
...
async def main_test_brief_to_blog():
    ...
    try:
        final_status, final_outputs = await run_workflow_test(
            ...
            validate_output_func=validate_orchestrator_workflow_output,
