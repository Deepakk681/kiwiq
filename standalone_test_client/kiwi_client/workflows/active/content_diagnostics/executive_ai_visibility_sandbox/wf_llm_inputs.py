...
# Max Tokens by Step
LLM_MAX_TOKENS = 5000  # Used for both query generation and report generation

# Model Names by Step
# Step 1: Query Generation
# Step 2: Report Generation
LLM_MODEL = "claude-sonnet-4-20250514"  # Used for both steps

# =============================================================================
# LLM Inputs for Executive AI Visibility Workflow
# =============================================================================
# This file contains prompts, schemas, and configurations organized by workflow steps:
# 1. Query Generation - Generate search queries for AI platforms to assess executive visibility
# 2. Report Generation - Analyze search results and create comprehensive visibility intelligence report

# =============================================================================
# STEP 1: QUERY GENERATION
# =============================================================================
# First step that generates strategic search queries to assess executive visibility
# across AI platforms like ChatGPT, Perplexity, Gemini, and Claude.
...
# Variables Used in Query Generation Prompts:
"""
Variables that go into the Query Generation prompts:
- current_date: Current date for temporal relevance
- linkedin_user_profile: Executive's LinkedIn user profile information
- linkedin_scraped_profile: Additional scraped profile data from LinkedIn
"""
...
# STEP 2: REPORT GENERATION
# =============================================================================
# Second step that analyzes search results from AI platforms and generates a comprehensive
# executive visibility intelligence report with strategic recommendations.
...
# Variables Used in Report Generation Prompts:
"""
Variables that go into the Report Generation prompts:
- loaded_query_results: Search results from AI platforms (perplexity, google, openai, anthropic)
"""

# Report Generation Output Schema
