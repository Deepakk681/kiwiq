...
from kiwi_client.workflows.active.content_diagnostics.executive_ai_visibility_sandbox.wf_executive_ai_visibility_json import (
    workflow_graph_schema,
)

from kiwi_client.workflows.active.content_diagnostics.executive_ai_visibility_sandbox.wf_testing.wf_inputs import (
    test_name,
    test_scenario,
)

from kiwi_client.workflows.active.content_diagnostics.executive_ai_visibility_sandbox.wf_testing.sandbox_setup_docs import (
    setup_docs,
    cleanup_docs,
)

WORKFLOW_NAME_TO_INGEST_AS_FOR_TESTING = "test_executive_ai_visibility_sandbox_workflow"
...
def get_workflow_paths():
    ...
    workflow_folder = current_file_dir.parent  # workflow main folder (executive_ai_visibility_sandbox)
...
async def validate_executive_ai_visibility_output(outputs: Optional[Dict[str, Any]]) -> bool:
    """
    ...
    logger.info("Validating executive ai visibility workflow outputs...")
...
async def main_test_executive_ai_visibility():
    """
...
if __name__ == "__main__":
    ...
    try:
        asyncio.run(main_test_executive_ai_visibility())
