...
from kiwi_client.workflows.active.playbook.blog_content_playbook_generation.wf_blog_content_playbook_generation_json import (
    workflow_graph_schema,
)

from kiwi_client.workflows.active.playbook.blog_content_playbook_generation.wf_testing.wf_inputs import (
    test_name,
    test_scenario,
)
...
from kiwi_client.workflows.active.playbook.blog_content_playbook_generation.wf_testing.wf_validation import (
    validate_playbook_output,
)

from kiwi_client.workflows.active.playbook.blog_content_playbook_generation.wf_testing.wf_state_filter_mapping import (
    state_filter_mapping,
)

WORKFLOW_NAME_TO_INGEST_AS_FOR_TESTING = "test_blog_content_playbook_generation_workflow"
...
async def main_test_brief_to_blog():
    ...
    try:
        ...
        if final_outputs:
            print(f"\nTest Results:")
            print(f"✓ Blog content playbook generated successfully")
...
if __name__ == "__main__":
    ...
    try:
        asyncio.run(main_test_blog_playbook())
