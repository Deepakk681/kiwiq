...
This workflow generates LinkedIn content briefs through multiple steps:
1. Topic Generation - Creates 5 strategic topic suggestions
2. Topic Selection (HITL) - User selects preferred topic
3. Knowledge Base Query - Research relevant information
4. Brief Generation - Creates comprehensive content brief
5. Brief Approval (HITL) - User reviews and provides feedback
6. Brief Feedback Analysis - Processes user feedback
7. Brief Revision - Updates brief based on feedback
"""
...
MAX_REGENERATION_ATTEMPTS = 3  # For topic regeneration
MAX_REVISION_ATTEMPTS = 3  # For brief revisions
...
# =============================================================================
# This step generates 5 strategic LinkedIn topic suggestions based on user input,
# executive profile, and content strategy. Each topic includes reasoning for
# why it was selected and how it addresses the user's needs.
...
# =============================================================================
# STEP 2.5: TOPIC FEEDBACK ANALYSIS (For HITL Feedback)
# =============================================================================
# This step analyzes user feedback on topic suggestions and provides
# revision instructions for topic regeneration.

class TopicFeedbackAnalysisSchema(BaseModel):
    """Schema for topic feedback analysis output."""
    revision_instructions: str = Field(
        description="Clear instructions for revising the topics based on feedback, specify what changes are needed for each topic"
    )
    alignment_notes: str = Field(
        description="How to maintain alignment with LinkedIn strategy while incorporating feedback"
    )
...
# =============================================================================
# After topic selection (Step 2 is HITL), this step generates research queries
# to find relevant information from the knowledge base to support the brief.
...
# =============================================================================
# STEP 4: BRIEF GENERATION - Supporting Schemas
# =============================================================================
# These schemas support the brief generation step which creates a comprehensive
# LinkedIn content brief with strategic reasoning.
...
# STEP 1: Topic Generation System Prompt
...
# STEP 3: Knowledge Base Query System Prompt
# Variables: None (uses context from user prompt)
...
# STEP 4: Brief Generation System Prompt
# Variables: None (uses context from user prompt)
...
# STEP 1: Topic Generation User Prompt Template
# Variables: {user_input}, {executive_profile}, {content_strategy}
...
# STEP 1 (Alternative): Topic Regeneration User Prompt Template
# Variables: {user_input}, {executive_profile}, {content_strategy}, {regeneration_feedback}
# Used when user requests new topics after initial generation
...
FEEDBACK ANALYSIS AND INSTRUCTIONS:
...
# =============================================================================
# STEP 2.5: TOPIC FEEDBACK PROMPTS
# =============================================================================
# Topic Feedback System Prompt
TOPIC_FEEDBACK_SYSTEM_PROMPT = """
You are an expert content strategist and feedback analyst for LinkedIn content.
You have been provided with:
1. Current topic suggestions with reasoning and expected impact
...
3. Specific guidance on maintaining alignment with LinkedIn strategy

CRITICAL REQUIREMENTS:
- Reference specific aspects of the executive profile that support the requested changes
- Explain which topics need adjustment and why
- Provide clear direction on maintaining consistency with content strategy
- Ensure topics continue to address LinkedIn audience expectations
- Respect the user's specific preferences and direction
"""

# Topic Feedback Initial User Prompt
# Variables: {current_topics}, {user_feedback}, {executive_profile}, {content_strategy}, {user_input}, {topic_hitl_additional_user_files}
...
IMPORTANT: The topic suggestions below include detailed reasoning and expected impact analysis for every topic.
...
3. Determine what changes are required, guided by:
   - The reasoning and impact analysis provided in the topics
   - The executive's positioning and expertise
   - The content strategy guidelines
   - The user's original input and requirements
4. Specify topic-specific changes while maintaining strategic alignment
...
Based on the feedback and all context provided:

1. Analyze what specific changes the user is requesting
2. Determine which topics need modification and why
3. Provide clear instructions for regenerating the topics
4. Maintain alignment with the executive's expertise and LinkedIn strategy
5. Create a brief, friendly message acknowledging the feedback

Output your analysis in the specified format.
"""

# STEP 3: Knowledge Base Query User Prompt Template
# Variables: {user_input}, {selected_topic}, {content_strategy}
...
# STEP 4: Brief Generation User Prompt Template
# Variables: {user_input}, {selected_topic}, {executive_profile}, {content_strategy}, {knowledge_base_research}
...
# =============================================================================
# STEP 6: BRIEF FEEDBACK ANALYSIS
# =============================================================================
# After brief approval HITL (Step 5), this step analyzes user feedback
# to create structured revision instructions.

# STEP 6: Brief Feedback Analysis System Prompt
# Variables: None (uses context from user prompt)
...
# STEP 6: Brief Feedback Initial User Prompt
# Variables: {content_brief}, {revision_feedback}, {executive_profile}, {content_strategy}, {selected_topic}, {knowledge_base_research}
...
# STEP 6 (Alternative): Brief Feedback Additional User Prompt
# Variables: {content_brief}, {revision_feedback}, {previous_revision_instructions}
...
# =============================================================================
# STEP 7: BRIEF REVISION
# =============================================================================
# This step applies the feedback analysis to revise the content brief.

# STEP 7: Brief Revision System Prompt
# Variables: None (uses context from user prompt)
...
# STEP 7: Brief Revision User Prompt Template
# Variables: {current_content_brief}, {brief_feedback_analysis}
...
# =============================================================================
# STEP 6: BRIEF FEEDBACK ANALYSIS - Supporting Schemas
# =============================================================================
