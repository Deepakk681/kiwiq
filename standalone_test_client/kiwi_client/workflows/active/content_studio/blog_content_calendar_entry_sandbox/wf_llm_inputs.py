...
# =============================================================================
# LLM Inputs for Blog Content Calendar Entry Workflow
# =============================================================================
# This file contains prompts, schemas, and configurations organized by workflow steps:
# 1. Theme Suggestion - Selects strategic theme for next blog post
# 2. Topic Generation - Generates specific topic ideas for the theme
# 3. Topic Refinement - Processes feedback and refines topics
...
# =============================================================================
# STEP 1: THEME SUGGESTION
# =============================================================================
# Selects the most strategic theme for the next blog post

# System prompt for theme suggestion
# Variables used: None (static prompt)
...
# User prompt template for theme suggestion
# Variables used:
# - {company_doc}: Company documentation
# - {playbook}: Content strategy playbook
# - {previous_topics}: Previously generated topics
