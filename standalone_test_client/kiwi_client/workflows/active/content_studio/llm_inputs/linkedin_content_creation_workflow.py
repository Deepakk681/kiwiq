...
Knowledge Base Analysis: {user_profile}
...
- User Profile: Use this ONLY for factual information and company-specific details. Do not let it dominate the content or style decisions.
...
Remember to use the user profile information sparingly and only for factual context.
