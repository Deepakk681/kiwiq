...
# =============================================================================
# LLM Inputs for LinkedIn Content Calendar Entry Workflow
# =============================================================================
# This file contains prompts, schemas, and configurations organized by workflow steps:
# 1. Topic Generation - Generate content topic suggestions for LinkedIn posts
# 2. Topic Refinement - Process feedback and iterate on topics
...
# =============================================================================
# Generates initial content topic suggestions for LinkedIn posts

# User prompt template for topic generation
# Variables used:
# - {current_datetime}: Current date and time
# - {user_profile}: User's profile information
# - {strategy_doc}: Content strategy document
# - {merged_posts}: Previous posts for style reference
# - {user_timezone}: User's timezone information
...
# System prompt template for topic generation
# Variables used:
...
# =============================================================================
# Generates additional topic suggestions based on feedback

# Additional user prompt template for topic refinement
# Variables used:
# - {current_datetime}: Current date and time
# - {user_profile}: User's profile information
# - {strategy_doc}: Content strategy document
# - {merged_posts}: Previous posts for style reference
# - {user_timezone}: User's timezone information
# - {existing_topics}: Already generated topics to avoid duplication
