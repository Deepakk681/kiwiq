...
from kiwi_client.workflows.active.content_studio.linkedin_alternate_text_suggestion_sandbox.wf_linkedin_alternate_text_suggestion_json import (
    workflow_graph_schema,
)

from kiwi_client.workflows.active.content_studio.linkedin_alternate_text_suggestion_sandbox.wf_testing.wf_inputs import (
    test_name,
    test_scenario,
)
...
from kiwi_client.workflows.active.content_studio.linkedin_alternate_text_suggestion_sandbox.wf_testing.wf_run_hitl_inputs import (
    hitl_inputs,
)

WORKFLOW_NAME_TO_INGEST_AS_FOR_TESTING = "test_linkedin_alternate_text_suggestion_workflow"
...
def get_workflow_paths():
    ...
    workflow_folder = current_file_dir.parent  # workflow main folder (linkedin_alternate_text_suggestion_sandbox)
