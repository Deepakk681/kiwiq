...
USER_KNOWLEDGE_BASE_ANALYSIS_DOCNAME_TEMPLATE = "knowledge_base_analysis"
USER_KNOWLEDGE_BASE_ANALYSIS_NAMESPACE_TEMPLATE = "knowledge_base_{item}"
USER_KNOWLEDGE_BASE_ANALYSIS_IS_VERSIONED = True
