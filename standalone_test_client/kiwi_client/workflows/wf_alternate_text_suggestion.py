...
USER_PROMPT_TEMPLATE_VARIABLES = {
    "selected_text": None,
    "content_draft": None,  # Changed from complete_content_doc to match template
    "user_dna": None,
    "feedback_section": ""  # Default empty string instead of None
}

USER_PROMPT_TEMPLATE_CONSTRUCT_OPTIONS = {
    "selected_text": "selected_text",
    "content_draft": "complete_content_doc",  # Direct string mapping since it's now a string
    "user_dna": "user_dna",
    "feedback_section": "user_feedback"  # Direct mapping to user_feedback field
}
