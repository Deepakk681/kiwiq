...
workflow_graph_schema = {
  "nodes": {
    ...
    "load_documents": { # Renamed from load_documents, now inside map loop
          ...
          "load_paths": [
              {
                  "filename_config": {
                      ...
                      "static_docname": "source_file_1",
                  },
                  "output_field_name": "source_file_1"
              },
              {
                  "filename_config": {
                      "input_namespace_field_pattern": UPLOADED_FILES_NAMESPACE_TEMPLATE, 
                      "input_namespace_field": "entity_username",
                      "static_docname": "source_file_2",
                  },
                  "output_field_name": "source_file_2"
              },
          ],
      ...
      # Writes: source_file_1, source_file_2 -> loaded_documents
    },
...
async def main_test_extraction_workflow():
    ...
    setup_docs: List[SetupDocInfo] = [
        {
            'namespace': test_namespace, 'docname': "source_file_1", 'is_versioned': False,
            'initial_data': {
                "source_filename": "source_file_1",
        ...
        {
            'namespace': test_namespace, 'docname': "source_file_2", 'is_versioned': False,
            'initial_data': {
                "source_filename": "source_file_2",
    ...
    cleanup_docs: List[CleanupDocInfo] = [
        {'namespace': test_namespace, 'docname': "source_file_1", 'is_versioned': False, 'is_shared': False},
        {'namespace': test_namespace, 'docname': "source_file_2", 'is_versioned': False, 'is_shared': False},
    ]
    setup_schemas = None
